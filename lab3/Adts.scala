...
object Adts {
  ...
  def main(args: Array[String]): Unit ={
    ...
    println(testGetNth(list, 3))
    println(testDouble(Some(1)))
    println(testIsEven(4))
    println(testIsEven(5))
    println(testSafeDivide(5, 0))

    def wz(line:String): Int = line.toInt / 0
    def woz(line:String): Int = line.toInt
    println(testGoodOldJava(wz, "6"))
    println(testGoodOldJava(woz, "7"))
  }
}