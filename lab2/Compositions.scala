...
object Compositions {
  ...
  def main(args: Array[String]): Unit = {
    val num: Int = 2
    println(testCompose((num:Int)=>num +2)((num:Int)=>num*num)((num:Int)=>num*2)(num))
    println(testMapFlatMap((num:Int)=> Some(num+2))((num:Int)=>Some(num*num))((num:Int)=>num*2)(Some(num)))
    println(testForComprehension((num:Int)=> Some(num+2))((num:Int)=>Some(num*num))((num:Int)=>num*2)(Some(num)))
  }
}
