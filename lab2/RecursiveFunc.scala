...
object RecursiveFunctions {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val list2 = Cons (6, Cons (7, Cons (8, Cons (9, Cons (10, Nil () ) ) ) ) )
    println (testReverse (list1))
    println(testMap(list1,(num:Int)=>num-1))
    println(testAppend(list1,list2))
    println(testFlatMap(list1,(num:Int)=> Cons(num-2, Nil())))
  }
}
